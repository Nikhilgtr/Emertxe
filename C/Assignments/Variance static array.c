/*  
 *  Q. Variance calculation with static arrays.
 *
 *  a. Create a set of numbers statically.
 *      -> Get the number through command line and 
 *      create a tunable array.
 *  b. Calculate variance of that set of numbers.
 *
 *
 *  Hints:
